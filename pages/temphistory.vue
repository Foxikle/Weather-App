...
const dateRange = ref<DateRange>({
  start: parseAbsolute(preferences.value.start ?? new Date(Date.now() - 24*3600*1000).toISOString(), 'UTC'),
  end: parseAbsolute(preferences.value.end ?? new Date().toISOString(), 'UTC'),
})
...
function getLineOptions(yFormatter?: (val: number) => string) {
  ...
  return {
    ...
    xaxis: { type: 'datetime', labels: { style: { colors: axisColor } }, axisBorder: { color: gridColor }, axisTicks: { color: gridColor } },
    yaxis: { labels: { style: { colors: axisColor }, formatter: (val: any) => typeof val === 'number' ? (yFormatter ? yFormatter(val) : nf.format(val)) : '' } },
    fill: { type: 'gradient', gradient: { shade: dark ? 'dark' : 'light', shadeIntensity: 0.2, opacityFrom: dark ? 0.2 : 0.25, opacityTo: 0.05, stops: [0, 90, 100] } },
          ...
          <Popover>
            <PopoverTrigger as-child>
              <Button variant="outline">
                <span v-if="dateRange.start && dateRange.end">{{ df.format(dateRange.start.toDate(getLocalTimeZone())) }} – {{ df.format(dateRange.end.toDate(getLocalTimeZone())) }}</span>
          ...
          <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.temp))" :series="dewpointSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.temp))" :series="temperatureSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + '%')" :series="humiditySeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.pressure))" :series="bpSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.power))" :series="solarSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v))" :series="uvSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.distance))" :series="rainSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + toAbbreviation(preferences.speed))" :series="windSeries" height="300" type="line" />
              </CardContent>
            </Card>
            ...
            <Card class="p-2">
              ...
              <CardContent class="mx-0 px-0">
                <apexchart :options="getLineOptions(v => ' ' + nf.format(v) + '%')" :series="batterySeries" height="300" type="line" />
              </CardContent>
            </Card>
          </div>
        </CardContent>
